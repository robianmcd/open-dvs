...
// and http://id3.org/id3v2.3.0#User_defined_URL_link_frame
    ...
    var MP4TagReader = function (_MediaTagReader) {
        ...
        _createClass(MP4TagReader, [{
            key: '_loadData',
            value: function _loadData(mediaFileReader, callbacks) {
                // MP4 allSongDetails isn't located in a specific location of the file. Roughly
                ...
                // allSongDetails. In order to find and load all the interesting atoms we need
                // to traverse the entire linked list of atoms and only load the ones
                // associated with allSongDetails.
                // The allSongDetails atoms can be find under the "moov.udta.meta.ilst" hierarchy.
